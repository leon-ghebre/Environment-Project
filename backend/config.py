...
# Valid metrics describe the core water quality sensor readings that will be used in the timeseries, summary and export endpoints.
# Unlike some other columns used throughout the backend, these columns are valid as a timeseries metric
VALID_METRICS = [
    "ph",
    "turbidity_ntu",
    "conductivity_uS_cm",
...
# Alert configuration
# Lebo Xhosa's acceptance criteria: alert triggers when reading deviates by more than 20% from the 24hr average
ALERT_DEVIATION_THRESHOLD = 0.2

# Configuration of export
# Jack Wilshere's acceptance criteria: exported file includes timestamps, site IDs and measurement values
EXPORT_COLUMNS = [
    "timestamp",
    "site_id",
    "ph",
